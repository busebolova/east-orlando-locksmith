    ...
    <>
      ...
      <section className="hero">
        <div className="hero__content">
          ...
          <p>{homepage.heroSubtitle || data.siteContent.hero.subtitle}</p>
          ...
          <div className="hero-actions">
            <a className="btn btn-hero-call btn-large" href={`tel:${data.phoneRaw}`}>
              <span className="header-phone btn-phone-pulse" aria-hidden="true">
              ...
              {homepage.callButtonText || `Call ${data.phone}`}
            </a>
          </div>
